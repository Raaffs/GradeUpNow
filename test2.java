...
class MCQ {
    ...
    MCQ(String quesno, String ques, String opt1, String opt2, String opt3, String opt4, String correctans) {
...
public class test2 {
    public static void main(String[] args) {
        String[] q1={"1","How many days does the earth take to revolve around the sun","360", "300", "365.25", "365", "C"};
        MCQ m1 = new MCQ (q1);
    }
}
